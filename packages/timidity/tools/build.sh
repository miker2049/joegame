...
BUILD_FLAGS="-sENVIRONMENT='web,worker' -s ALLOW_MEMORY_GROWTH=1 -s MODULARIZE=1 -s EXPORT_NAME=LibTimidity -s EXPORTED_FUNCTIONS=@tools/exports.json \
...
OPTIMIZE_FLAGS_PROD="-Oz "
OPTIMIZE_FLAGS_DEBUG=" -DTIMIDITY_DEBUG"

...
public:
  ...
  static float noise(float x, size_t seed);
  // 2D Perlin simplex noise
  static float noise(float x, float y, size_t seed);
  // 3D Perlin simplex noise
  static float noise(float x, float y, float z, size_t seed);

  // Fractal/Fractional Brownian Motion (fBm) noise summation
  float fractal(size_t octaves, size_t seed, float x) const;
  float fractal(size_t octaves, size_t seed, float x, float y) const;
  float fractal(size_t octaves, size_t seed, float x, float y, float z) const;

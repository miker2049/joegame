...
export default interface IjoegameFacade {
  ...
  loadAssets(game: Phaser.Game, config: LevelConfig): Promise<Phaser.Game>
  loadMapJSON(game: Phaser.Game, path: LevelConfig): Promise<Phaser.Game>
  ...
  runLevelScene(game: Phaser.Game, config: LevelConfig): ILevelComponents

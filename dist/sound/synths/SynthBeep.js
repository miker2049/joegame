...
var _default = /*#__PURE__*/function () {
  ...
  function _default() {
    ...
    this.synth = new Tone.PolySynth().toDestination(); // this.seq = new Tone.Sequence((time, note) => {
  ...
  (0, _createClass2.default)(_default, [{
    key: "play",
    value: function play() {
      console.log(this.synth); // console.log(Tone.Transport.state)
      // this.seq.start(0.05)

      var now = Tone.now();
      this.synth.triggerAttackRelease("C4", "16n"); // this.synth.triggerAttackRelease("E4", "16n", now + 0.5)

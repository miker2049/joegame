declare function getKeyName(path: string): string;
declare function getSceneKeyName(path: string): string;
declare function getDialogueKeyName(path: string): string;
